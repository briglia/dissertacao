...
Título de Mestre em Informática. Área de concentração: Inteligência Artificial.
}}
...
Prof. Edward David Moreno, Ph.D. -- Orientador \\
...
Prof. \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \\
...
Sistemas embarcados geralmente possuem limitações de memória e processamento. Com o aumento do uso dos dispositivos móveis é mais comum encontrarmos sistemas operacionais embarcados, como o Linux, sendo usados para executar aplicações multimída, acessar a Internet, etc. Aumentar a memória de um dispositivo pode ser custoso e implementar mecanismos via software é uma saída mais barata.
...
A ferramenta desenvolvida nesta dissertação mostra a possibilidade de utilizar a classificação de padrões de consumo de memória usando Mapas Auto-Organizáveis para implementar um Cache Comprimido Adaptativo, que consiga se adequar ao consumo da memória em tempo de execução.
...
Embedded systems usually have memory and processing limitations. Due the growth of mobile devices usage, it is common to see embedded systems being used to run multimedia applications, access the Internet, etc. Increase the mobile memory amount could be expensive and implement a software solution is cheaper than latter one. 
...
The developed tool presented in this dissertation shows the possibility of using memory consumption patterns through Self Organized Maps usage in Adaptative Compressed Cache. This approach makes Cache Compression behavior aligned with memory consumption in real time. 
