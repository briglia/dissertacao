...
Nas Figuras XXXX podemos visualizar que os mapas são levemente diferentes entre os três cenários apresentados. Porém, o mais importante é a área de visitação que cada aplicação possui. É esta área que será utilizada para identificar qual aplicação está sendo executada no sistema e com isso gerar uma tomada de decisão para o Cache Comprimido.
