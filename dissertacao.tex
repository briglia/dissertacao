...
\subsubsection{Testes com o Mibench}
\label{sec:mibench}
...
Neste seção são apresentados os dados obtidos através do treinamento da rede neural e classificação dos padrões de consumo utilizando SOMs.
...
\subsection{Treinando a rede neural e criando o SOM}
...
\subsection{Classificando as aplicações}
...
\subsection{Adaptatividade no Cache Comprimido}
